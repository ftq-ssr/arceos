...
///输出[dev]
pub fn print_dev(args: core::fmt::Arguments) ->fmt::Result {
    let mut vga=VGA.lock();
    vga.set_color(Some(VgaTextColorCode::new(
        VgaTextColor::Blue,VgaTextColor::Black,
    )));
    print_str("[DEV] ");
    vga.set_color(None);
    vga.write_fmt(args)
...
pub fn print_debug(args: core::fmt::Arguments) ->fmt::Result {
    let mut vga=VGA.lock();
    vga.set_color(Some(VgaTextColorCode::new(
        VgaTextColor::Cyan,VgaTextColor::Black,
    )));
    print_str("[DEBUG] ");
    vga.set_color(None);
    vga.write_fmt(args)
